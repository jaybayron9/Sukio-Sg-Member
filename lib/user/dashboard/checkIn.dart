...
class _CheckInState extends State<CheckIn> {
  ...
  Future<void> refreshAttendance() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final response = await http.post(Uri.parse('https://ww2.selfiesmile.app/member/check/attendance/status'), body: {'member_id': prefs.getString('authId').toString()});
    if (response.statusCode == 200) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text('A CSR program of ', style: TextStyle(color: Colors.white, fontSize: 12)),
                          GestureDetector(
                              onTap: () {
                      ...
                      child: FutureBuilder<List<Map<String, dynamic>>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (hasData) {
                            return Center(
                              heightFactor: 10,
                              child: Text('No Check-in History', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey.shade500)),
                            );
                          }
